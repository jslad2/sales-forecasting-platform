        ...
        try:
            ...
            if start_forecast:
                ...
                try:
                    ...
                    # Validate y_original length before assigning
                    if len(train) == len(y_original):
                        train["y"] = y_original
                    else:
                        st.warning("⚠️ Mismatch: train and y_original lengths are different. Skipping assignment.")
